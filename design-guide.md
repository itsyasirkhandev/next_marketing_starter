...
- **data-slot attribute** for styling component parts (every primitive now has this)
...
- **Item**: Display lists of items, cards, etc.
- **Field**: Unified form field component
...
- [shadcn/ui Changelog](mdc:https://ui.shadcn.com/docs/changelog)
...
- forwardRefs removed from components
...
- [ ] Uses Sonner instead of deprecated Toast component
...
- [ ] Using deprecated Toast component (use Sonner instead)
- [ ] Using deprecated "default" style (use "new-york")